...
Sub ROTATE(Destdc As Long, Angle As Currency, x&, y&, W&, H&, ImgHandle&, Optional TranspColor&, Optional Alpha As Currency = 1, Optional pScale As Currency = 1, Optional px% = -32767, Optional py% = -32767)
...
' = No Transparent COlor
           ...
           'The AntiAliased NO-Alpha assigment of colors
           ProcessedBits(0, XX + CX, YY + CY) = P(0, ix, iy) * TopL + P(0, ix + 1, iy) * TopR + P(0, ix, iy + 1) * BotL + P(0, ix + 1, iy + 1) * BotR
           ProcessedBits(1, XX + CX, YY + CY) = P(1, ix, iy) * TopL + P(1, ix + 1, iy) * TopR + P(1, ix, iy + 1) * BotL + P(1, ix + 1, iy + 1) * BotR
           ProcessedBits(2, XX + CX, YY + CY) = P(2, ix, iy) * TopL + P(2, ix + 1, iy) * TopR + P(2, ix, iy + 1) * BotL + P(2, ix + 1, iy + 1) * BotR
